...
¿Qué son los canales (Feeds) y como puede utilizarlos?
...
$lang['Bad status for user "guest", using default status. Please notify the webmaster.'] = 'Estado erroneo del usuario "invitado". Se está utilizando el estado predeterminado. Por favor, informe al administrador de la web.';
