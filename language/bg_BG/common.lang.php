...
=======
$lang['You can manage your API keys in your <a href="%s">account settings.</a>'] = 'Можете да управлявате вашите API ключове в настройките на вашия <a href="%s"> акаунта.';
$lang['%d visits'] = '%d посещения';
$lang['This will not be displayed again. You must copy it to continue.'] = 'Това няма да се показва отново. Трябва да го копирате, за да продължите.';
$lang['To continue using the API, please renew your key before it expires.'] = 'За да продължите да използвате API, подновете ключа си преди изтичането му.';
$lang['To manage your API keys, please log in with your username/password.'] = 'За да управлявате вашите API ключове, влезте с вашето потребителско име/парола.';
$lang['Unknown time period'] = 'Неизвестен период от време';
$lang['Validate'] = 'Валидирай';
$lang['When enabled, a common template is used for the login and registration pages, regardless of the theme.'] = 'Когато е активирано, общ шаблон се използва за страниците за вход и регистрация, независимо от темата.';
$lang['You can try to edit your filters and perform a new search.'] = 'Можете да опитате да редактирате филтрите си и да извършите ново търсене.';
$lang['You have no email address, so you will not be notified when your API key is about to expire.'] = 'Нямате имейл адрес, така че няма да бъдете уведомени, когато вашият API ключ изтича.';
$lang['Your API key will expire in %d day.'] = 'Вашият API ключ ще изтече след %d ден.';
$lang['Your API key will expire in %d days.'] = 'Вашият API ключ ще изтече след %d дни.';
$lang['Your API key will expire soon'] = 'Вашият API ключ ще изтече скоро';
$lang['Your changes have been applied.'] = 'Промените ви са приложени.';
$lang['Your password was successfully reset'] = 'Паролата ви беше успешно нулирана';
$lang['Your password was successfully set'] = 'Паролата ви беше успешно зададена';
$lang['last 12 months'] = 'Последните 12 месеца';
$lang['last 24 hours'] = 'последните 24 часа';
$lang['last 3 months'] = 'Последните 3 месеца';
$lang['last 30 days'] = 'Последните 30 дни';
$lang['last 6 months'] = 'Последните 30 дни';
$lang['last 7 days'] = 'Последните 7 дни';
$lang['last year'] = 'Миналата година';
$lang['must not be empty'] = 'не трябва да е празно';
$lang['rating score %s'] = 'оценка %s';
$lang['year %d'] = 'година %d';
$lang['you must choose a date'] = 'трябва да изберете дата';
$lang['Only the first %d albums are displayed, out of %d.'] = 'Показват се само първите %d албума от общо %d.';
$lang['Options'] = 'Опции';
$lang['Pages'] = 'Страници';
$lang['Password: ********** (no copy by email)'] = 'Парола: ********** (не се копира по имейл)';
$lang['Pre-established filters are proposed, but you can add or remove them using the "Choose filters" button.'] = 'Предварително зададени филтри са предложени, но можете да ги добавяте или премахвате чрез бутона "Избери филтри".';
$lang['Public key copied.'] = 'Публичният ключ е копиран.';
$lang['Related albums'] = 'Свързани албуми';
$lang['Return to <a href="identification.php" title="Sign in">Sign in</a>'] = 'Върни се на Вход';
$lang['Return to the gallery'] = 'Върни се в галерията';
$lang['Revoke'] = 'Отмени';
$lang['Revoked'] = 'Отменено';
$lang['Save your secret Key and ID'] = 'Запазете своя таен ключ и ID';
$lang['Search in :'] = 'Търсене в:';
$lang['Search in this set'] = 'Търсене в този сет';
$lang['Secret key copied. Keep it in a safe place.'] = 'Таен ключ е копиран. Запазете го на сигурно място.';
$lang['Set my password'] = 'Задай моята парола';
$lang['Set your password below.'] = 'Задайте вашата парола по-долу.';
$lang['Show expired keys'] = 'Покажи изтекли ключове';
$lang['Start-Date'] = 'Начална дата';
$lang['Tags found'] = 'Намерени тагове';
$lang['Tags listed here match your search by word. Click on one to browse by tag.'] = 'Таговете тук съответстват на вашето търсене по дума. Кликнете на някой, за да разгледате по таг.';
$lang['The PDF you requested is too large to display on this page.'] = 'PDF файлът, който заявихте, е твърде голям за показване на тази страница.';
$lang['The api key has been successfully created.'] = 'API ключът е успешно създаден.';
$lang['The email %s will be used to notify you when your API key is about to expire.'] = 'Имейлът %s ще бъде използван за уведомяване, когато вашият API ключ изтича.';
$lang['The secret key can no longer be displayed.'] = 'Тайният ключ вече не може да се показва.';
$lang['There are no authors available for the photos currently filtered'] = 'Няма налични автори за филтрираните снимки';
$lang['There are no creation dates available for the photos currently filtered'] = 'Няма налични дати на създаване за филтрираните снимки';
$lang['There are no tags available for the photos currently filtered'] = 'Няма налични тагове за филтрираните снимки';
$lang['This API key was manually revoked on %s'] = 'Този API ключ беше ръчно отменен на %s';
$lang['Create a new API key to secure your account.'] = 'Създайте нов API ключ за защита на акаунта си.';
$lang['Create an account'] = 'Създайте нов акаунт';
$lang['Created at'] = 'Създаден в';
$lang['Custom date'] = 'Персонализирана дата';
$lang['Custom dates'] = 'Персонализирани дати';
$lang['Do you really want to revoke the "%s" API key?'] = 'Наистина ли искате да оттеглите API ключ "%s"?';
$lang['Don\'t have an account yet ?'] = 'Все още нямате акаунт?';
$lang['Done'] = 'Готово';
$lang['Duration'] = 'Продължителност';
$lang['Edit API Key'] = 'Редактирай API ключ';
$lang['Empty filters'] = 'Изчисти филтрите';
$lang['Expert mode'] = 'Експертен режим';
$lang['Expired'] = 'Изтекъл';
$lang['Expired on'] = 'Изтекъл на';
$lang['Expires in'] = 'Изтича след';
$lang['File type'] = 'Тип файл';
$lang['Fill in the filters to start a search'] = 'Попълнете филтрите, за да започнете търсене';
$lang['Filters'] = 'Филтри';
$lang['Generate API Key'] = 'Генерирай API ключ';
$lang['Generate key'] = 'Генерирай ключ';
$lang['Hello <em>%s</em>, enter your new password below.'] = 'Здравей %s, въведете новата си парола по-долу.';
$lang['Hide expired keys'] = 'Скрий изтеклите ключове';
$lang['Impossible to copy automatically. Please copy manually.'] = 'Невъзможно за автоматично копиране. Моля копирайте ръчно.';
$lang['Last use'] = 'Последно ползвано';
$lang['Manage your account'] = 'Управление на акаунта';
$lang['Never'] = 'Никога';
$lang['New API Key'] = 'Нов API ключ';
$lang['No expiration'] = 'Без изтичане';
$lang['No results are available.'] = 'Няма налични резултати.';
$lang['Choose filters'] = 'Изберете филтри';
$lang['Choose how you want to see your gallery'] = 'Изберете как искате да видите галерията';
$lang['Clear'] = 'Изчисти';
$lang['Click here to display it'] = 'Кликнете тук за показване';
$lang['Confirm my new password'] = 'Потвърдете новата си парола';
$lang['Confirm new password'] = 'Потвърдете новата парола';
$lang['Create API Keys to secure your acount'] = 'Създайте API ключове за защита на акаунта';
$lang['3xlarge'] = '3XL – изключително голям';
$lang['4xlarge'] = '4XL – гигантски';
$lang['API Key has been successfully edited.'] = 'API ключът е успешно редактиран.';
$lang['API Key has been successfully revoked.'] = 'API ключът е успешно оттеглен.';
$lang['API Key name'] = 'Име на API ключ';
$lang['API Key not found'] = 'API ключът не е намерен';
$lang['API Keys'] = 'API ключове';
$lang['Account'] = 'Акаунт';
$lang['Added by'] = 'Добавено от';
$lang['Album already selected'] = 'Албумът вече е избран';
$lang['Album description'] = 'Описание на албума';
$lang['Album name, 1 &rarr; 5 &rarr; 10 &rarr; 100'] = 'Име на албума, 1 &rarr; 5 &rarr; 10 &rarr; 100';
$lang['Album name, 100 &rarr; 10 &rarr; 5 &rarr; 1'] = 'Име на албума, 100 &rarr; 10 &rarr; 5 &rarr; ';
$lang['Album title'] = 'Заглавие на албум';
$lang['Albums found'] = 'Намерени албуми';
$lang['Albums listed here match your search by word. Click on one to browse by album.'] = 'Албумите, показани тук, съответстват на търсенето ви по дума. Кликнете върху някой, за да разгледате албума.';
$lang['Already have an account ?'] = 'Вече имате акаунт?';
$lang['An email has been sent with a link to reset your password'] = 'Изпратен е емейл с линк за нулиране на паролата';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'Възникна грешка, моля върнете се на Вход или Регистрация';
$lang['Cancel'] = 'Отказ';
$lang['Change your password'] = 'Сменете паролата си';
$lang['Check your inbox'] = 'Проверете си имейла ';
>>>>>>> Hood-fr-PWG-plugins
