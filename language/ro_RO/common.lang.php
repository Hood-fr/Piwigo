...
$lang['3xlarge'] = '3XL – extra mare';
$lang['4xlarge'] = '4XL – gigantic';
$lang['API Key has been successfully edited.'] = 'Cheia API a fost editată cu succes.';
$lang['API Key has been successfully revoked.'] = 'Cheia API a fost revocată cu succes.';
$lang['API Key name'] = 'Numele cheii API';
$lang['API Key not found'] = 'Cheia API nu a fost găsită';
$lang['API Keys'] = 'Chei API';
$lang['Account'] = 'Cont';
$lang['Album already selected'] = 'Album deja selectat';
$lang['Album description'] = 'Descrierea albumului';
$lang['Albums found'] = 'Albume găsite';
$lang['Albums listed here match your search by word. Click on one to browse by album.'] = 'Albumele listate aici corespund căutării tale după cuvinte. Fă clic pe unul pentru a naviga în album.';
$lang['Already have an account ?'] = 'Ai deja un cont?';
$lang['An email has been sent with a link to reset your password'] = 'A fost trimis un e-mail cu un link pentru resetarea parolei.';
$lang['An email has been sent with a verification code'] = 'A fost trimis un e-mail cu un cod de verificare.';
$lang['An error has occured please got back to <a href="identification.php" title="Sign in">Sign in</a> or <a href="register.php">Register</a>'] = 'A apărut o eroare. Te rugăm să revii la <a href="identification.php" title="Autentificare">Autentificare</a> sau <a href="register.php">Înregistrare</a>.';
$lang['Cancel'] = 'Anulează';
$lang['Change your password'] = 'Schimbă parola';
$lang['Check your inbox'] = 'Verifică-ți căsuța de e-mail';
$lang['Choose filters'] = 'Alege filtrele';