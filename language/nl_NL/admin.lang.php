...
$lang['%d anomaly has been ignored.'] = '%d onregelmatigheid zijn genegeerd.';
...
$lang['Hide'] = 'Verberg';
$lang['Password is missing. Please enter the password.'] = 'Wachtwoord ontbreekt. Geef je wachtwoord a.u.b.';
...
$lang['WARNING! This plugin does not seem to be compatible with this version of Piwigo.'] = 'PAS OP! Deze plugin schijnt niet compatibel te zijn met deze versie van Piwigo.';
$lang['Do you want to activate anyway?'] = 'Wil je desondanks activeren?';
$lang['THIS PLUGIN IS NOW PART OF PIWIGO CORE! DELETE IT NOW.'] = 'DEZE PLUG-IN IS NU ONDERDEEL VAN PIWIGO CORE! VERWIJDER DE PLUGIN NU.';
$lang['ERROR: THIS PLUGIN IS MISSING BUT IT IS INSTALLED! UNINSTALL IT NOW.'] = 'FOUT: DEZE PLUGIN NIET GEVONDEN MAAR IS GEÏNSTALLEERD! DEÏNSTALLEER DE PLUGIN NU.';
...
$lang['The Piwigo publish Plug-in allows you to export and synchronize photos from Lightroom directly to your Piwigo photo gallery.'] = 'Met de Piwigo Publish plug-in kun je foto\'s direct vanuit Lightroom naar uw Piwigo fotogalerie exporteren en synchroniseren.';
...
$lang['First photo added'] = '1e Toegevoede foto';
...
$lang['Piwigo %s is available, please update'] = 'Piwigo %s is beschikbaar, bijwerke a.u.b.';
...
$lang['Piwigo Remote Sync is able to upload a whole folder hierarchy. If you run it again, only new photos will be uploaded.'] = 'Met Piwigo Remote Sync is het mogelijk om een hele map-hiërarchie te uploaden. Als Piwigo Remote Sync daarna nogmaals gebruikt, zullen alleen nieuwe foto\'s worden geüpload.';
...
$lang['Share / Send your photos directly from your Mac Os X (10.10 and following) to Piwigo'] = 'Deel / Stuur uw foto\'s direct vanaf uw Mac Os X (10,10 en volgende) naar Piwigo';
$lang['Time has come to update your Piwigo with version %s, go to %s'] = 'De tijd is gekomen om jouw Piwigo bij te werken naar versie %s, gaat u naar %s';
...
$lang['Are you sure you want to delete all sizes?'] = 'Weet u zeker dat u alle groottes wil verwijderen?';
$lang['Are you sure you want to delete the language "%s"?'] = 'Weet je zeker dat je de taal "%s" wil verwijderen?';
$lang['Are you sure you want to delete the plugin "%s"?'] = 'Weet je zeker dat je de plug-in "%s" wil verwijderen?';
...
$lang['No plugins found'] = 'Geen plugins gevonden';
...
$lang['%d Activities'] = '%dActiviteiten';
