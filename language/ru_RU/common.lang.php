...
$lang['Please register'] = 'Зарегистрируйтесь или войдите как пользователь, чтобы избежать кода captcha, и возможность редактировать или удалять ваши комментарии';